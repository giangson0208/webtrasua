                              ...
                              <tbody>
                                <tr>
                                  <td><table border="0" cellpadding="0" cellspacing="0" width="100%">
                                      <tbody>
                                        <tr>
                                          <td colspan="2"><strong>CỬA HÀNG TRÀ SỮA SMILE TEA</strong></td>
                                        </tr>
                                        <tr>
                                          <td>Địa chỉ</td>
                                          <td>: Hoàng Mai - Thành Phố Hà Nội</td>
                                        </tr>
                                        <tr>
                                          <td width="65">Tel:</td>
                                          <td>: 0424 666888</td>
        ...
        <br />
                          ...
                          <table width="100%" style="border-collapse:collapse;">
                            <tr>
                              ...
                              <td width="30%" bgcolor="#CCCCCC"  align="left" style="border:1px solid green;"><div align="center">Tên sản phẩm</div></td>
        ...
        <tr style="border:1px solid green;">
          ...
          <td align="right" ><b><?php echo number_format($tong,"0",",",".") ?> VNĐ</b></td>
              ...
              <table width="452" border="0" align="right">
                            ...
                            <tr>
                              <td height="23"><div align="center">(Ký tên +Đóng dấu cửa hàng)</div></td>
                              <td>&nbsp;</td>
                              <td>&nbsp;</td>
                            </tr>
                            <tr>
