						...
						<h2><?php echo $row['tendm']?></h2>
							<div class="sanphamcon">
								...
								<div class="dienthoai">
									...
									<h4>Giá : <?php echo number_format(($result['gia']*((100-$result['khuyenmai1'])/100)),0,",",".");?> VNĐ</h4>
									<div class="button">
										<ul>
											<li>
	...
	?>
				<div class="sanpham">			
						<h2>VỊ TRÀ SỮA BÁN CHẠY</h2>
					<div class="sanphamcon">
					    <?php 
						    $sql1="select * from sanpham inner join danhmuc on sanpham.madm = danhmuc.madm where dequi=17 order by daban  DESC limit 6 ";
				...
				<!------------------------------------------------------------------------------------------------------------------->
                <div class="sanpham">			
						<h2>VỊ TRÀ SỮA MỚI</h2>
					<div class="sanphamcon">
					    <?php 
						    $sql1="select * from sanpham inner join danhmuc on sanpham.madm = danhmuc.madm where dequi=17 order by idsp  DESC limit 6 ";
							$result1= mysql_query($sql1);
						?>
						<?php 
						  while ($row=mysql_fetch_array($result1))
